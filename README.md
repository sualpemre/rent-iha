...
![Django](assets/django-icon.png) ![React-TypeScript](assets/react-icon.png) ![PostgreSQL](assets/postgresql-icon.png) ![Ngnix](assets/ngnix-icon.png) ![Docker](assets/docker-icon.png)
